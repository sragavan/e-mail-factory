...
static const _ExtendedGDBusArgInfo _egdbus_folder_method_info_get_message_by_fd_IN_ARG_uid =
{
  {
    -1,
    "uid",
...
static const _ExtendedGDBusArgInfo _egdbus_folder_method_info_get_message_by_fd_IN_ARG_ops =
{
  {
    -1,
    "ops",
...
static const _ExtendedGDBusArgInfo _egdbus_folder_method_info_get_message_by_fd_IN_ARG_message =
{
  {
    -1,
    "message",
...
static const _ExtendedGDBusArgInfo * const _egdbus_folder_method_info_get_message_by_fd_IN_ARG_pointers[] =
{
  &_egdbus_folder_method_info_get_message_by_fd_IN_ARG_uid,
  &_egdbus_folder_method_info_get_message_by_fd_IN_ARG_ops,
  &_egdbus_folder_method_info_get_message_by_fd_IN_ARG_message,
  NULL
};

static const _ExtendedGDBusMethodInfo _egdbus_folder_method_info_get_message_by_fd =
{
  {
    -1,
    "getMessageByFd",
    (GDBusArgInfo **) &_egdbus_folder_method_info_get_message_by_fd_IN_ARG_pointers,
    NULL,
    NULL
  },
  "handle-get-message-by-fd",
  TRUE
};
...
static const _ExtendedGDBusMethodInfo * const _egdbus_folder_method_info_pointers[] =
{
  ...
  &_egdbus_folder_method_info_get_message_by_fd,
 ...
 * @handle_get_message_by_fd: Handler for the #EGdbusFolder::handle-get-message-by-fd signal.
...
egdbus_folder_default_init (EGdbusFolderIface *iface)
{
  ...
  /**
   * EGdbusFolder::handle-get-message-by-fd:
   * @object: A #EGdbusFolder.
   * @invocation: A #GDBusMethodInvocation.
   ...
   * @arg_message: Argument passed by remote caller.
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-org-gnome-evolution-dataserver-mail-Folder.getMessageByFd">getMessageByFd()</link> D-Bus method.
   *
   * If a signal handler returns %TRUE, it means the signal handler will handle the invocation (e.g. take a reference to @invocation and eventually call egdbus_folder_complete_get_message_by_fd() or e.g. g_dbus_method_invocation_return_error() on it) and no order signal handlers will run. If no signal handler handles the invocation, the %G_DBUS_ERROR_UNKNOWN_METHOD error is returned.
   *
   * Returns: %TRUE if the invocation was handled, %FALSE to let other signal handlers run.
   */
  g_signal_new ("handle-get-message-by-fd",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (EGdbusFolderIface, handle_get_message_by_fd),
    g_signal_accumulator_true_handled,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_BOOLEAN,
...
/**
 * egdbus_folder_call_get_message_by_fd:
 * @proxy: A #EGdbusFolderProxy.
 * @arg_uid: Argument to pass with the method invocation.
 * @arg_ops: Argument to pass with the method invocation.
 * @arg_message: Argument to pass with the method invocation.
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously invokes the <link linkend="gdbus-method-org-gnome-evolution-dataserver-mail-Folder.getMessageByFd">getMessageByFd()</link> D-Bus method on @proxy.
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 * You can then call egdbus_folder_call_get_message_by_fd_finish() to get the result of the operation.
 *
 * See egdbus_folder_call_get_message_by_fd_sync() for the synchronous, blocking version of this method.
 */
void
egdbus_folder_call_get_message_by_fd (
    EGdbusFolder *proxy,
...
/**
 * egdbus_folder_call_get_message_by_fd_finish:
 * @proxy: A #EGdbusFolderProxy.
 * @out_fd_list: (out): Return location for a #GUnixFDList or %NULL.
 * @res: The #GAsyncResult obtained from the #GAsyncReadyCallback passed to egdbus_folder_call_get_message_by_fd().
 * @error: Return location for error or %NULL.
 *
 * Finishes an operation started with egdbus_folder_call_get_message_by_fd().
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * egdbus_folder_call_get_message_by_fd_sync:
 * @proxy: A #EGdbusFolderProxy.
 * @arg_uid: Argument to pass with the method invocation.
 * @arg_ops: Argument to pass with the method invocation.
 * @arg_message: Argument to pass with the method invocation.
 ...
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-org-gnome-evolution-dataserver-mail-Folder.getMessageByFd">getMessageByFd()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 * See egdbus_folder_call_get_message_by_fd() for the asynchronous version of this method.
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * egdbus_folder_complete_get_message_by_fd:
 * @object: A #EGdbusFolder.
 * @invocation: (transfer full): A #GDBusMethodInvocation.
 * @fd_list: (allow-none): A #GUnixFDList or %NULL.
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-org-gnome-evolution-dataserver-mail-Folder.getMessageByFd">getMessageByFd()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 * This method will free @invocation, you cannot use it afterwards.
 */
void
